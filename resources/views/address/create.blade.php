@extends('layouts.app')
@section('title',__('titles.titles.address_add'))
@section('content')
    <div class="container mt-5 w-50">
        ...
        <div class="card">
            <div class="card-title">
                <div class="row">
                    <div class="col-8">
                        <h5 class="mt-2 ms-2">{{__('titles.address.add')}}</h5>
                    </div>
                    <div class="col-4">
                        @if(session('status'))
                            <a href="{{route('address.select')}}" class="btn btn-primary mt-2 me-2 float-end">{{__('titles.address.go_to_select')}}</a>
                        @endif
                    </div>
                </div>
            </div>
            <div class="card-body">
                <form action="{{route('address.store')}}" method="post">
                    ...
                    <div class="row mb-3">
                        ...
                        <div class="col-6">
                            <div class="form-floating">
                                <input value="{{old('identity_number')}}" type="text" maxlength="11"
