                ...
                <div class="col-md-4 mb-sm-3">
                    <div class="card address-card">
                        <div class="card-body text-center">
                            <a class="btn bi bi-plus-circle d-block" style="border-radius: 25%"></a>
                            <a href="" class="text-decoration-none text-dark">Yeni Adres Ekle</a>
                        </div>
                    </div>
                </div>
                @foreach ($addresses as $address)
                    <div class="col-md-4">
                        <div class="card address-card mb-sm-3">
                            <div class="card-body">
                                ...
                                <a href="{{ route('address.edit', $address->id) }}"
                                   class="btn btn-outline-primary bi bi-pencil-square float-end"> Adresi Düzenle</a>
                            </div>
                        </div>
                    </div>
                @endforeach
